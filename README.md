...
### ⚡ 2+ Years · 4 Enterprise Employers · Real Production Impact

| 🏆 99% | 🤖 95% | 📋 100% | 🚀 8 |
|:---:|:---:|:---:|:---:|
| Search time reduction @ Fiserv | QA efficiency gain @ Boehringer | Paper workflows eliminated | MCP servers in MCCS |
...
joshith = {
    ...
    "location":    "Atlanta, GA",
    "education":   "CS Honors + Data Science Minor · Georgia State · 3.89 GPA · Magna Cum Laude",
    "currently":   "AI & Automation Engineer @ Janus International",
    "building":    ["Agentic workflows", "LLM-powered automation", "Enterprise AI systems"],
    "experience":  "2+ years · Janus · Boehringer Ingelheim · Fiserv · Cognizant",
    "newsletter":  "AI Engineering Roadmap 2026 (LinkedIn)",
    "superpower":  "Turning AI demos into production systems that actually ship",
}
```
...
<details>
<summary><b>🏗️ AI & Automation Engineer — Janus International</b> &nbsp;|&nbsp; Apr 2026 – Present</summary>

<br>

Building agentic AI workflows and LLM-powered automation systems for enterprise construction operations.

**Projects shipped:**
- **Betco Estimating** — AI-powered construction estimating automation
- **Betco AP** — Accounts payable intelligence automation
- **Order Intake & Order Entry** — End-to-end order processing automation

**Stack:** LLM orchestration · Agentic workflows · Enterprise automation

</details>

<details>
<summary><b>🧬 Advanced AI & Applications Engineer — Boehringer Ingelheim</b> &nbsp;|&nbsp; Aug 2025 – Apr 2026</summary>

<br>

| Achievement | Impact |
|---|---|
| YOLOv8 CV system on edge hardware + industrial cameras | **95% QA efficiency improvement** |
| Full-stack manufacturing tracking portal (React, Next.js, SQL Server, Docker, Azure) | **98% manual reporting reduction** |
| PowerApps vehicle registration workflow | **100% of paper workflows eliminated** |
| PowerApps + Power Automate + Power BI employee onboarding & KPI system | **100% manual HR intervention eliminated** |

</details>

<details>
<summary><b>💳 Data & GenAI Engineer — Fiserv</b> &nbsp;|&nbsp; Jan 2024 – Aug 2025</summary>
...
<details>
<summary><b>🤖 GenAI Engineer — Cognizant</b> &nbsp;|&nbsp; May – Aug 2023</summary>

<br>

- Fine-tuned BERT, GPT, LSTM with TensorFlow and PyTorch for NLP tasks
- Prompt engineering, ethical AI, and bias detection research
- **🏆 CSA GenAI Star Performer** — top intern recognition company-wide

</details>

<details>
<summary><b>📊 Data Analyst Research Assistant — GSU RIMMES</b> &nbsp;|&nbsp; Aug 2022 – Aug 2023</summary>

<br>

- Analyzed 10M+ rows of Amazon/Walmart data — Python, SQL, regression, K-Means, time series
- Built Tableau/Power BI dashboards — 40% processing reduction, 30% decision speed improvement
- Supported 250+ students in Statistics and Discrete Mathematics
...
### 🏭 MCCS
**Multi-Agent Manufacturing Intelligence**

The most complex system I've built.
- 8 MCP servers
- 7 agentic agents
- 5 cognitive agents
- Causal graph reasoning
- Monte Carlo simulation
- LLM executive decision layer

</td>
<td width="50%">

### 🏥 TaskForceAI
**7-Agent Healthcare Copilot** · HackGT

- EMR review agent
- Insurance simulation agent
- Evidence retrieval agent
- 4 additional specialist agents
- Built at HackGT hackathon
...
**LinkedIn Newsletter + GitHub Series**

Teaching the next generation of AI engineers — tool calling, validation, agentic systems, RAG. Episode by episode.

[→ Subscribe](https://www.linkedin.com/newsletters/ai-engineering-roadmap-2026-7467249724752908288/)
...
| 🧠 Anthropic | ❄️ Snowflake | ☁️ Microsoft | 🐳 DevOps |
|:---:|:---:|:---:|:---:|
| Claude + Amazon Bedrock | GenAI Professional | Azure AI Professional | Docker Foundations |
| Advanced MCP | Data Engineering Professional | | Kubernetes (3 levels) |
| | | | Jenkins |

| 🤖 AI/ML | 💡 Other |
|:---:|:---:|
| AMD: RL with LLMs | Applied ML Algorithms |
| UiPath RPA | N8N Automation |
...
B.S. Computer Science + Data Science Minor · **3.89 GPA · Magna Cum Laude**
President's List (4.27 GPA, Summer 2025) · Dean's List every other semester
...
I'm building a public curriculum — episode by episode — to teach real AI engineering. Not tutorials. Systems.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:22C55E,50:7F77DD,100:534AB7&height=120&section=footer"/>

*Building AI systems that actually ship · Atlanta, GA*
